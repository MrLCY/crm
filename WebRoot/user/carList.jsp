			...
			<form action="" method="post">
				<table class="table table-striped table-bordered table-condensed">
					...
					<tr>
						...
						<td class="active"  ><h6 class="text-muted text-center"><a href="user/carLook.jsp" >查看</a></h6></td>
						<td class="active"><h6 class="text-muted text-center"><a href="user/carEdit.jsp" class="text-center">编辑</a></h6></td>
