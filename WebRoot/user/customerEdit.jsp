  ...
  <body>
    <div class="container-fluid">
			<nav class="breadcrumb"><i class="Hui-iconfont"></i>
				...
				<li class="">
					<span class="text-success">编辑客户信息</span>
				</li>
			...
			<form action="" method="post">
				...
				<tr><td colspan="4"><h5 class="text-info text-center">编辑客户信息</h5></td></tr>
				<tr>
					...
					<tr><td><h6 class="text-info ">驾驶证类型</h6></td><td><input type="text" class="form-control"/></td>
					</tr>
