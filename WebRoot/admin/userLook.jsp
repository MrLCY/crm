  ...
  <body>
    <div class="container-fluid">
			...
			<form action="" method="post">
				...
				<tr><td colspan="2"><h5 class="text-info text-center">用户详细信息</h5></td></tr>
					<tr><td><h6 class="text-info">用户名</h6></td><td>11</td></tr>
					<tr><td><h6 class="text-info">真实姓名</h6></td><td>22</td></tr>
					<tr><td><h6 class="text-info">性别</h6></td><td>男</td></tr>
					<tr><td><h6 class="text-info">电话</h6></td><td>33</td></tr>
